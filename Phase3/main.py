...
class Meme:
    ...
    def __init__(self, caption, image):
        ...
        if re.search("[\u4e00-\u9FFF]", caption):
            self.font = ImageFont.truetype(font=self.fontfileC, size=fontSize)
        else:
...
if __name__ == "__main__":
    ...
    # 無輸入直接測試
    # putcaptions(caption='哈哈哈笑死', array=arr, imgID='test')
